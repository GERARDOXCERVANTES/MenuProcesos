...
public class RRForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        quantumSpiner = new javax.swing.JSpinner();
        ...
        NomProcesoLabel.setText("Round   Robin");
        panelP.add(NomProcesoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 30, -1, -1));
        ...
        panelP.add(eliminarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 120, -1, 30));
        ...
        panelP.add(NomParametros, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 570, 20));
        ...
        panelP.add(GraficaButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, 110, 30));
        ...
        panelP.add(mover, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 930, -1));
        ...
        panelP.add(rendimi_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 160, 160, -1));

        espera_title.setFont(new java.awt.Font("Roboto", 3, 14)); // NOI18N
        espera_title.setText("Tiempo de espera promedio");
        panelP.add(espera_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 30, 190, -1));

        servicio_Title.setFont(new java.awt.Font("Roboto", 3, 14)); // NOI18N
        servicio_Title.setText("Tiempo de servicio promedio");
        panelP.add(servicio_Title, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 90, 190, -1));

        jSeparator2.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 200, 170, 10));

        jSeparator3.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 70, 170, 10));

        jSeparator4.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, 170, 10));

        I_label.setText("---");
        panelP.add(I_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 180, 100, -1));

        EsperaP_label.setText("---");
        panelP.add(EsperaP_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 50, 100, -1));

        TServicio_Label.setText("---");
        panelP.add(TServicio_Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 120, 100, -1));
        panelP.add(quantumSpiner, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, -1, -1));

        QUANTUMLabel.setFont(new java.awt.Font("Roboto Black", 1, 12)); // NOI18N
        QUANTUMLabel.setText("QUANTUM");
        panelP.add(QUANTUMLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 70, -1, -1));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelP, javax.swing.GroupLayout.DEFAULT_SIZE, 954, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelP, javax.swing.GroupLayout.DEFAULT_SIZE, 561, Short.MAX_VALUE)
        );
    ...
    private void AgregarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarButtonMouseClicked
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            panelP.add(datoslabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(300 + (80 * (i - 1)), currentY, 60, -1));

            // Añadir el JLabel a la lista de resultLabels
            resultLabels.add(datoslabel);
        }
    ...
    private void eliminarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eliminarButtonMouseClicked
        ...
        private void CalcularbuttonMouseClicked(java.awt.event.MouseEvent evt) {
        ArrayList<Procesos> procesos = new ArrayList<>();
        ArrayList<String> ordenEjecucion = new ArrayList<>();
        ArrayList<Integer> tiemposEjecucion = new ArrayList<>();
        ...
        try {
            ...
            int quantum = (Integer) quantumSpiner.getValue();
            if (quantum == 0) {
                JOptionPane.showMessageDialog(this, "ERROR: QUANTUM NO PUEDE ESTAR EN 0. POR FAVOR ASIGNAR VALOR MAYOR A 0.", "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
    
            // Ejecutar el algoritmo Round Robin
            ejecutarRR(procesos, quantum, ordenEjecucion, tiemposEjecucion);
    ...
    private void GraficaButtonMouseClicked(java.awt.event.MouseEvent evt) {
        ArrayList<Procesos> procesos = new ArrayList<>();
        ArrayList<String> ordenEjecucion = new ArrayList<>();
        ArrayList<Integer> tiemposEjecucion = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < processFields.size(); i += 3) {
                String nombre = processFields.get(i).getText();
                int tiempoLlegada = Integer.parseInt(processFields.get(i + 1).getText());
                int tiempoEjecucion = Integer.parseInt(processFields.get(i + 2).getText());
            ...
            // Ejecutar el algoritmo Round Robin y almacenar los datos de ejecución
            ejecutarRR(procesos, quantum, ordenEjecucion, tiemposEjecucion);
    
            // Mostrar la ventana de la gráfica de Round Robin
            GraficaRR graficaRR = new GraficaRR(procesos, ordenEjecucion, tiemposEjecucion, quantum);
            graficaRR.setVisible(true);
    ...
    private void ejecutarRR(ArrayList<Procesos> procesos, int quantum, ArrayList<String> ordenEjecucion, ArrayList<Integer> tiemposEjecucion) {
        if (procesos.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debe agregar procesos primero.");
            return;
        }
    
        Queue<Procesos> colaProcesos = new LinkedList<>(procesos);
        int tiempoActual = 0;
        Map<Procesos, Integer> tiemposOriginales = new HashMap<>();
    
        // Guardar el tiempo de ejecución original de cada proceso
        for (Procesos proceso : procesos) {
            tiemposOriginales.put(proceso, proceso.getTiempoEjecucion());
        }
    
        while (!colaProcesos.isEmpty()) {
            boolean procesoEjecutado = false;
    
            for (Procesos procesoActual : new ArrayList<>(colaProcesos)) {
                // Solo ejecutar si el proceso ya ha llegado
                if (procesoActual.getTiempoLlegada() <= tiempoActual) {
                    procesoEjecutado = true;
                    colaProcesos.remove(procesoActual);  // Eliminar de la cola
    
                    int tiempoRestante = procesoActual.getTiempoEjecucion();
                    if (tiempoRestante > quantum) {
                        // El proceso no ha terminado, ejecutamos solo el quantum
                        tiempoActual += quantum;
                        procesoActual.setTiempoEjecucion(tiempoRestante - quantum);
                        colaProcesos.add(procesoActual);  // Reinsertar al final de la cola
                    } else {
                        // El proceso ha terminado
                        tiempoActual += tiempoRestante;
                        procesoActual.setTiempoEjecucion(0);
                        procesoActual.tiempoF = tiempoActual;  // Tiempo de finalización
    
                        // Calcular tiempos relevantes
                        int tiempoEjecucionOriginal = tiemposOriginales.get(procesoActual);
                        procesoActual.tiempoS = procesoActual.tiempoF - procesoActual.getTiempoLlegada(); // Tiempo de servicio
                        procesoActual.tiempoE = procesoActual.tiempoS - tiempoEjecucionOriginal; // Tiempo de espera
                        procesoActual.rendimiento = ((float) tiempoEjecucionOriginal / procesoActual.tiempoS) * 100; // Rendimiento
                    }
    
                    // Agregar a las listas de seguimiento para la gráfica
                    ordenEjecucion.add(procesoActual.getNombre());
                    tiemposEjecucion.add(tiempoActual);
                    break;
                }
            }
    
            // Si ningún proceso fue ejecutado, avanzar el tiempo
            if (!procesoEjecutado) {
                tiempoActual++;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RRForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JSpinner quantumSpiner;
