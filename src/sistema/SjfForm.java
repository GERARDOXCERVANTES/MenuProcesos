 ...
 * @author cerva
 */
public class SjfForm extends javax.swing.JFrame {

    /**
     * Creates new form SjfForm
     */
    public SjfForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        NomProcesoLabel.setText("Short Job First");
        panelP.add(NomProcesoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, -1, -1));
        ...
        panelP.add(mover, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 980, -1));
        ...
        panelP.add(espera_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 40, 190, -1));

        EsperaP_label.setText("---");
        panelP.add(EsperaP_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 60, 100, -1));

        servicio_Title.setFont(new java.awt.Font("Roboto", 3, 14)); // NOI18N
        servicio_Title.setText("Tiempo de servicio promedio");
        panelP.add(servicio_Title, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 100, 190, -1));

        TServicio_Label.setText("---");
        panelP.add(TServicio_Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 130, 100, -1));

        I_label.setText("---");
        panelP.add(I_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 190, 100, -1));

        rendimi_title.setFont(new java.awt.Font("Roboto", 3, 14)); // NOI18N
        rendimi_title.setText("Rendimiento promedio ");
        panelP.add(rendimi_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 170, 160, -1));

        jSeparator3.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 80, 170, 10));

        jSeparator4.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 150, 170, 10));

        jSeparator2.setBackground(new java.awt.Color(102, 102, 102));
        panelP.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 210, 170, 10));
        ...
        panelP.add(OrdenarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 120, -1, 30));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/sjfImagen.jpg"))); // NOI18N
        panelP.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 250, 210, 220));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelP, javax.swing.GroupLayout.PREFERRED_SIZE, 999, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelP, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 579, Short.MAX_VALUE)
        );
    ...
    public void ejecutarSJF(ArrayList<Procesos> procesos){
        ...
        for (Procesos proceso : procesos) {
            ...
            proceso.setTiempoF(proceso.tiempoF = tiempoActual + proceso.tiempoEjecucion);
    ...
    private void OrdenarP() {
        int posicion;
        int aux;
        String auxN;
        ArrayList<Integer> tiempoE = new ArrayList<>();
        ...
        for (int i = 0; i < processFields.size(); i += 3) {
            ...
            if (nombre.trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "por favor de llenar todos los campos", "verificar", JOptionPane.WARNING_MESSAGE);

            }
    
            tiempoE.add(tiempoEjecucion);
            nombres.add(nombre); 
        }
    
        
        int[] tiempoE2 = new int[tiempoE.size()];
        String[] nombresA = new String[nombres.size()];
    
        for (int j = 0; j < tiempoE.size(); j++) {
            tiempoE2[j] = tiempoE.get(j);
            nombresA[j] = nombres.get(j);
        }
    
        
        for (int i = 1; i < tiempoE2.length; i++) {
            posicion = i;
            aux = tiempoE2[i];
            auxN = nombresA[i];
    
            while (posicion > 0 && tiempoE2[posicion - 1] > aux) {
                tiempoE2[posicion] = tiempoE2[posicion - 1];
                nombresA[posicion] = nombresA[posicion - 1]; 
                posicion--;
            }
            tiempoE2[posicion] = aux;
            nombresA[posicion] = auxN;
        }
    
        // Actualizar processFields con los valores ordenados
        for (int k = 0; k < tiempoE2.length; k++) {
            processFields.get(k * 3).setText(nombresA[k]); // Nombre
            processFields.get((k * 3) + 2).setText(String.valueOf(tiempoE2[k])); // Tiempo de ejecución
        }
    }
    ...
    private void OrdenarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OrdenarButtonMouseClicked
        OrdenarP();
    }//GEN-LAST:event_OrdenarButtonMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SjfForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
